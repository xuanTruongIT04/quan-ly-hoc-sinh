...
| Phase | Goal | Status |
|-------|------|--------|
| **1 — MVP** | Next.js + **file-based mock data**, Vietnamese content, quản lý học sinh + điểm danh + tính học phí, deployed to Vercel to demo | **We are here** |
| **2 — Near-complete** | Xuất **phiếu học phí** (html2canvas → ảnh) + **VietQR** thanh toán + nhận xét/lịch dạy | Not started |
| **3 — Full** | Hoàn thiện UX, thống kê doanh thu theo ngày/tháng/năm, bàn giao cho Trang Nhung dùng | Not started |
